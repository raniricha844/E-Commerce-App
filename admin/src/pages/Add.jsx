...
const Add = ({token}) => {
 ...
 const onSubmitHandler = async (e) => {
     ...
     try{
      ...
      const response = await axios.post(backandUrl + "/api/product/add" , formData , {headers:{token}})
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 '>
      ...
      <button type='submit' className='w-28 py-3 mt-4 bg-black text-white rounded-md hover:bg-slate-300 hover:text-black'>ADD</button>
    </form>
  )
}
